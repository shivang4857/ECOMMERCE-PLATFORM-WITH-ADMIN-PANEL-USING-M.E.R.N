...
const filters = [
  ...
  },
  {
    ...
    name: "Category",
    options: [
      { value: "Clothing", label: "New Arrivals", checked: false },
      { value:"Electronics", label: "Sale", checked: false },
      { value: "Beauty", label: "Travel", checked: true },
      { value: "Electronics", label: "Organization", checked: false },
      { value:  "Books", label: "Accessories", checked: false },
    ],
  },
  {
    id: "size",
